...
public class MPass1 {
    public static void main(String[] args) throws IOException {
        BufferedReader br1 = new BufferedReader(new FileReader("C:\\Users\\vspat\\Desktop\\spos all prs\\Input.txt"));
        String line;
        mdt[] MDT = new mdt[20];
        mnt[] MNT = new mnt[4];
        ...
        br1.close();
        BufferedWriter bw1 = new BufferedWriter(new FileWriter("C:\\Users\\vspat\\Desktop\\spos all prs\\mnt.txt"));
        System.out.println("\n\n*****MACRO NAME TABLE*****");
        System.out.println("\n\tINDEX\tNAME\tADDRESS");
        ...
        bw1.close();
        bw1 = new BufferedWriter(new FileWriter("C:\\Users\\vspat\\Desktop\\spos all prs\\arglist.txt"));
        System.out.println("\n\n*****ARGUMENT LIST*****");
        System.out.println("\n\tINDEX\tNAME\tADDRESS");
        ...
        System.out.println("\n\tINDEX\tSTATEMENT");
        bw1 = new BufferedWriter(new FileWriter("C:\\Users\\vspat\\Desktop\\spos all prs\\mdt.txt"));
