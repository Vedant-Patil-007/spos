...
class Pass1 {
    public static void main(String args[]) throws NullPointerException, FileNotFoundException {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\vspat\\Desktop\\spos all prs\\pr1\\Sample.txt"));
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\vspat\\Desktop\\spos all prs\\pr1\\Output.txt"));
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\vspat\\Desktop\\spos all prs\\pr1\\Output.txt"));
            System.out.println("\n** Output.txt **\n");
    ...
    public static int search(String token, Obj[] list, int cnt) {
        if (token == null || list == null || cnt < 0 || cnt > list.length) {
            return -1;  // Invalid input
        }
        for (int i = 0; i < cnt; i++) {
            if (list[i] != null && token.equalsIgnoreCase(list[i].name)) {
                return i;
            }
        }
        return -1;
