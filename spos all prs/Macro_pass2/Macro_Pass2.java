...
public class Macro_Pass2 {
    public static void main(String[] args) throws IOException {
        ...
        mdt[] MDT=new mdt[20]; mnt[] MNT=new mnt[4];
        ...
        BufferedReader br1 = new BufferedReader(new FileReader("C:\\Users\\vspat\\Desktop\\spos all prs\\mnt.txt"));
        String line;
        while ((line = br1.readLine()) != null) {
            String[] parts = line.split("\\s+");
            System.out.println("\t" + "\t" + parts[0] + "\t" + parts[1] + "\t\t" + parts[2]);
            MNT[mnt_cnt++] = new mnt(parts[0],  parts[1], parts[2]);
        ...
        br1 = new BufferedReader(new FileReader("C:\\Users\\vspat\\Desktop\\spos all prs\\argmnt.txt"));
        while ((line = br1.readLine()) != null) {
        ...
        br1 = new BufferedReader(new FileReader("C:\\Users\\vspat\\Desktop\\spos all prs\\Input.txt"));
        arglist[] actual_parameter = new arglist[10];
        BufferedWriter bw1 = new BufferedWriter(new FileWriter("C:\\Users\\vspat\\\\Desktop\\spos all prs\\Output.txt"));
        while ((line = br1.readLine()) != null) {
            ...
            if (macro_call != -1) {
                ...
                while (true) {
                    if (MDT[macro_addr].stmnt.contains("mend") ||
                            MDT[macro_addr].stmnt.contains("MEND")) {
                        macro_call = -1;
                        break;
                    } else {
                        bw1.write("\n");
